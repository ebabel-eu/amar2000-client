...
/***/ function(module, exports, __webpack_require__) {
	...
	var _dashboard = __webpack_require__(159);
	
	var _dashboard2 = _interopRequireDefault(_dashboard);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	(0, _reactDom.render)(_react2.default.createElement(_dashboard2.default, null), document.getElementById('root')); // React
	    ...
	    value: function render() {
	      ...
	      if (data) {
	        return _react2.default.createElement(
	          'div',
	          { className: 'container' },
	          _react2.default.createElement(_pageHeader2.default, { title: 'AMAR2000', subtitle: 'Office environment monitoring' }),
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              'div',
	              { className: 'col-md-3 col-sm-6' },
	              _react2.default.createElement(_panel2.default, { title: 'Humidity', type: 'humidity', unit: '%', data: this.state.data.humidity, ranges: humidityRanges })
	            ),
	            _react2.default.createElement(
	              'div',
	              { className: 'col-md-3 col-sm-6' },
	              _react2.default.createElement(_panel2.default, { title: 'Noise', type: 'noise', unit: 'dB', data: this.state.data.noise, ranges: noiseRanges })
	            )
	          )
	        );
	      } else {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/sass-loader/index.js!./page-header.scss", function() {
				var newContent = require("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/sass-loader/index.js!./page-header.scss");
...
/***/ function(module, exports) {
	...
	var Ranges = function () {
	  function Ranges(lowest, low, high, highest) {
	  ...
	  _createClass(Ranges, [{
	    key: 'statusText',
	    value: function statusText(data, type) {
	      var text = '';
	    ...
	    key: 'isWarning',
	    value: function isWarning(data) {
	      return data !== null && (this.isHigh(data) || this.isLow(data));
	    }
	  }, {
	    key: 'isLow',
	    value: function isLow(data) {
	      return data !== null && data <= this.low && data >= this.lowest;
	    }
	  }, {
	    key: 'isHigh',
	    value: function isHigh(data) {
	      return data !== null && data >= this.high && data <= this.highest;
	    }
	  }, {
	    key: 'isSafe',
	    value: function isSafe(data) {
	      return data !== null && data > this.low && data < this.high;
	    }
	  }, {
	    key: 'isDanger',
	    value: function isDanger(data) {
	      return data !== null && (this.isTooHigh(data) || this.isTooLow(data));
	    }
	  }, {
	    key: 'isTooLow',
	    value: function isTooLow(data) {
	      return data !== null && data <= this.lowest;
	    }
	  }, {
	    key: 'isTooHigh',
	    value: function isTooHigh(data) {
